...
namespace AppWebAspLoginUsuario
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250024\\SENAC;Initial Catalog=login;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "UPDATE users  SET nome='" + txbNome.Text.ToString() + "', email='" + txbEmail.Text.ToString() + "', pass='" + txbPass.Text.ToString() + "', numero='" + txbNum.Text.ToString() + "' WHERE id_user='" + id_user+"'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
